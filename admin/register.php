                            ...
                            <div class="row ">
                                <div class="col-lg-12">
                                    <div class="input-form">
                                        <input type="text" name="cnm" placeholder="Enter your name">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="input-form">
                                        <input type="email" name="cem" placeholder="Enter your email">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="input-form">
                                        <input type="text" name="ccn" placeholder="Contact Number">
                                    </div>
                                </div>
                                <div class="col-lg-6">
...
$q="insert into register values('$cnm','$cem','$ccn','$select','$cadd','$cpass')";
mysqli_query($cn,$q);
mysqli_close($cn);
