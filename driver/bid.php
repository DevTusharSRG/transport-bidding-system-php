...
<?php
                   ...
                   $q="select * from corder where oid=$oid";
...
?>
    ...
    <main>
      ...
      <h2 align="center" class="contact-title">order details</h2>
                    <div class="container">
...
echo "<td>$vh</td>";
echo "<td>$max</td>";
echo "<td><input type=text id=bidding name=bidding placeholder=Give your bidding></td>";
echo "<td><input type=submit id=btnsub name=btnsub value=send></td>";
